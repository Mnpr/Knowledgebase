...
_(Note that the one space between each column was added by the way [`print()`](https://docs.python.org/3/tutorial/../library/functions.html#print "print") works: it always adds spaces between its arguments.)_
